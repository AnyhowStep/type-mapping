...
tape(__filename, t => {
    ...
    t.deepEqual(f("x", { a : 2, a2 : 3, b : "  test  ", b2 : "qwerty" }), { a2 : 2, b2 : "test" });
    t.deepEqual(f("x", { a2 : 2, b2 : "test" }), { a2 : undefined, b2 : undefined });
    t.false(tm.tryMap(f, "x", { a : "2" } as any).success);
    t.deepEqual(f("x", { a : 2 }), { a2 : 2, b2 : undefined });
    t.deepEqual(f("x", { b : "test" }), { a2 : undefined, b2 : "test" });
    t.deepEqual(f("x", { a : undefined, a2 : 4, b : "test" }), { a2 : undefined, b2 : "test" });
