...
export const test_0 = extraParamsOf(mixed_0);
export const test_1 = extraParamsOf(mixed_1);
export const test_2 = extraParamsOf(mixed_2);
export const test_3 = extraParamsOf(mixed_3);
...
export const test_0b = extraParamsOf(mixed_0b);
export const test_1b = extraParamsOf(mixed_1b);
export const test_2b = extraParamsOf(mixed_2b);